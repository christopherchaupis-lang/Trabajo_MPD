...
# ---------------------------------------------------------------
    ...
    bt_mae_sel, bt_rmse_sel, bt_mape_sel, bt_tabla_sel = backtest_temporal(df_feat_sel)
...
# ---------------------------------------------------------------
    ...
    modelo_final_sel = entrenar_modelo_completo(df_feat_sel)
    pronostico_sel = pronosticar_futuro(df_feat_sel, modelo_final_sel, n_semanas=N_SEMANAS_FUTURO)
    _, _, _, bt_tabla_sel_fc = backtest_temporal(df_feat_sel)
